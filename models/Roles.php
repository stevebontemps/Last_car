...
class Roles extends EntityModel
{
     private $id;
     private $nom;
     private $short_name;
    ...
    public function Create($post) {
        ...
        if($response == 0 ):
            throw new \Exception("La création de 'Roles' n'a pas pu être effectuée !");
        else:
            return $response;
        endif;
    }
    ...
    public function Retrieve(){
        ...
        if($response == 0 ):
            throw new \Exception("La récupération de 'Roles' n'a pas pu être effectuée !");
        else:
            return $response;
        endif;
    }
    ...
    public function Update($aPropVal){
        ...
        if($response == 0 ):
            throw new \Exception("La mise à jour de 'Roles' n'a pas pu être effectuée !");
        else:
            return $response;
        endif;
    }
    ...
    public function Delete(){
        ...
        if($response == 0 ):
            throw new \Exception("La suppression de 'Roles' n'a pas pu être effectuée !");
        else:
            return $response;
        endif;
    }
