...
class Pays extends EntityModel
{
    ...
    public function Create($post) {
        ...
        if($response == 0 ):
            throw new \Exception("La création de 'Pays' n'a pas pu être effectuée !");
        else:
            return $response;
        endif;
    }
    ...
    public function Retrieve(){
        ...
        if($response == 0 ):
            throw new \Exception("La récupération de 'Pays' n'a pas pu être effectuée !");
        else:
            return $response;
        endif;
    }
    ...
    public function Update($aPropVal){
        ...
        if($response == 0 ):
            throw new \Exception("La mise à jour de 'Pays' n'a pas pu être effectuée !");
        else:
            return $response;
        endif;
    }
    ...
    public function Delete(){
        ...
        if($response == 0 ):
            throw new \Exception("La suppression de 'Pays' n'a pas pu être effectuée !");
        else:
            return $response;
        endif;
    }
