...
//            vardump($this->controller);
    ...
    private function getValue($value) {
        if (is_array($value)) {
            return (isset($value[$this->method])) ? "Lastcar\\controllers\\" . $value[$this->method] : null;
        } else {
            return "Lastcar\\controllers\\" . $value;
        }
    }
...
//                    new Response("/message", array("message"=>"Vous tentez d'accéder à une ressource non autorisée !"));
//                    $this->controller = "Lastcar\\controllers\\DefaultController:showForm";
//                    vardump($this->controller);
//                    die();
                    return false;
                }
